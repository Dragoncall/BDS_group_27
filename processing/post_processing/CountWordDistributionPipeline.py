...
class FilterWordDistributionPipeline(CheckpointedPipelineStep):
    ...
    def _do_work(self, input, *args, **kwargs):
        ...
        with open(f'{dir_path}/../../resources/stopwords.json', 'r') as f:
            ...
            elif keys_top[1] in json_dict :
                stop_words = json_dict[keys_top[1]]['associated_stopwords']
...
class ReduceWordDistributionPipeline(CheckpointedPipelineStep):
    """Takes a dictionary {word : count}. Returns top most frequent items."""
    def _do_work(self, input, *args, **kwargs):
